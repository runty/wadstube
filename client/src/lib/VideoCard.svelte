...
<style>
  ...
  .card.watched .thumb img { opacity: .68; }
  ...
  .card-title:hover, .card-channel:hover { color: var(--accent-text); text-decoration: underline; }
  ...
  .favorite { color: var(--accent-text); }
  .card-channel { color: var(--accent-text); font-size: .88rem; font-weight: 700; text-decoration: none; font-family: var(--wads-display-font); }
  ...
  .actions button.active { color: var(--accent-text); border-color: var(--accent-text); }
  .actions button.ack { color: var(--accent-text); border-color: var(--accent-text); }
  ...
  @media (pointer: coarse), (max-width: 900px) {
    .actions button, :global(.grid.compact) .actions button { min-height: 44px; padding: 8px; font-size: .85rem; }
  }
</style>
